import { InventoryReadStore } from "./inventoryReadStore.js";
...
export class PlaceholderInventoryReadStore extends InventoryReadStore {
  listHubs(tenantId) {
    const t = requireTenant(tenantId);
    if (!t) return null;
    return [...t.hubs].sort((a, b) =>
      a.displayName.localeCompare(b.displayName) || a.hubId.localeCompare(b.hubId)
    );
  }
